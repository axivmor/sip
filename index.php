      ...
      <div class="row">
        <div class="col-xs-12 col-md-4 col-md-offset-4">
          ...
          <fieldset>
            ...
            <legend class="center">Ingresa</legend>

            <!-- Caja de texto para usuario -->
            <label class="sr-only" for="user">Usuario</label>
            <div class="input-group">
              <div class="input-group-addon"><i class="fa fa-user"></i></div>
              <input type="text" class="form-control" id="user" placeholder="Correo electrónico">
            </div>
              ...
              <p>
                No tienes una cuenta? <a href="registro.php"> Registrate!</a>
                 ...
                 <p>
                  ...
                  <legend class="center">PROTEGEMOS TU SALUD MAXGYM</legend>
